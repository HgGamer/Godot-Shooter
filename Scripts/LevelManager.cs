...
public class LevelManager : Node
{
	...
	void AddRoom(int door,int door2,string room)
	{
		Spatial lastdoor = lastroom.GetDoor(door);
		PackedScene prefab = (PackedScene)ResourceLoader.Load("res://"+room+".tscn");
		...
		instance.Rotate(Vector3.Up, (1.57079633f*(door) - lastroom.Rotation.y));
		GD.Print(lastroom.Rotation.y);
